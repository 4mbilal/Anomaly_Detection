...
@click.option("--gate", type=int, default=0)
@click.option("--wavelet", type=int, default=0)
@click.option("--wavelet_type", type=str, default="haar")
@click.option("--wavelet_levels", type=int, default=2)
@click.option("--pca", type=int, default=0)
@click.option("--pca_components", type=int, default=16)
@click.option("--pca_patch", type=int, default=8)
@click.option("--pca_stride", type=int, default=8)
def net(
        backbone_names,
