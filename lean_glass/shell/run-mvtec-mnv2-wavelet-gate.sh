...
#    --gate 1      learnable per-stream weights (init=equal; trains per class)
#                  so the wavelet stream isn't force-averaged at equal weight.
#  --downsampling 16 (first -le layer is /16). Fresh run_name.
#  Controls to compare against: dw2 (your locked result) and, ideally,
#  dw2+gate with --wavelet 0 to isolate the gate from the wavelet.
# ============================================================
