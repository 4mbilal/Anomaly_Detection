...
#  Added stream:
#    --pca 1                 patch-level PCA reconstruction-residual map,
#                            fit on normal training images, injected as a 4th
#                            feature stream (coarse global-appearance cue).
#    --pca_components 16 --pca_patch 8 --pca_stride 8
#  --downsampling 8 (first -le layer is /8). Fresh run_name.
#  Everything else identical to the 20-epoch baseline. --pca 0 == dw3.
