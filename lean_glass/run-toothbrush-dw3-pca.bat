@echo off
REM ============================================================
REM  TOOTHBRUSH only: 3-layer MobileNetV2 (depthwise) + PCA stream (Windows).
...
REM  --distribution 2 forces MANIFOLD (toothbrush's shipped value) -> no xlsx lookup.
REM  --downsampling 8 (first -le layer is /8). Fresh run_name.
